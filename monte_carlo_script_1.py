...
SSSF_HHKnK_L_integrated(80, 0.063, 0.062, 0.011, 0.05, h110, np.ones(4)*np.pi, 1.25, 1.75, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.063_Jyy=0.062_Jzz=0.011_h110=0.05_HHKnK_L_integrated", 1.5, 0.3)
SSSF_HHKnK_L_integrated(80, 0.063, 0.062, 0.011, 0.15, h110, np.ones(4)*np.pi, 1.25, 1.75, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.063_Jyy=0.062_Jzz=0.011_h110=0.15_HHKnK_L_integrated", 1.5, 0.3)
