...
#findXYZPhase_separate(-0.5, 1, -0.5, 1, 40, 30, 2, np.ones(4)*np.pi, "phase_XYZ_0_field_pi_flux", 0)
findXYZPhase_separate(0,1,-1,0,20,30,2,np.zeros(4), "phase_XYZ_0_field_0_flux_nS=1_01-10", 1, False)
