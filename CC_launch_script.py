...
DSSF(0.01, -2*Jpm, -2*Jpm, 1, 0, h001, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03/h001=0")
DSSF(0.01, -2*Jpm, -2*Jpm, 1, 0.1, h001, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03/h001=0.1")
DSSF(0.01, -2*Jpm, -2*Jpm, 1, 0.2, h001, np.zeros(4), 30, "Files/DSSF/Jpm=-0.03/h001=0.2")
