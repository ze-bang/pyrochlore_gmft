...
DSSF(300, -2*Jpm, -2*Jpm, 1, 0, h111, np.zeros(4), 30, "Files/DSSF/Jpm=0.02/h111=0")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.15, h111, np.zeros(4), 30, "Files/DSSF/Jpm=0.02/h111=0.15")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.3, h111, np.zeros(4), 30, "Files/DSSF/Jpm=0.02/h111=0.3")
