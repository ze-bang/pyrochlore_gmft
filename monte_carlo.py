...
def scan_all(n, L):
    scan_line('./monte_carlo_files/Jpm_0.3/', -0.6, 1, -0.6, 0, 1, 40, n, 0, 0, 1, L, -7, 1, 200, 100000)
    scan_line('./monte_carlo_files/Jpm_-0.3/', 0.6, 1, 0.6, 0, 1, 40, n, 0, 0, 1, L, -7, 1, 200, 100000)
    scan_line('./monte_carlo_files/Jpm_0.1/', -0.2, 1, -0.2, 0, 1, 40, n, 0, 0, 1, L, -7, 1, 200, 100000)
    scan_line('./monte_carlo_files/Jpm_-0.1/', 0.2, 1, 0.2, 0, 1, 40, n, 0, 0, 1, L, -7, 1, 200, 100000)
