...
from core.misc_helper import hnhltoK, hkztoK, genBZ
from core.observables import SSSFGraphHHL
import h5py
import pathlib
...
def scan_all(n, L):
    scan_line('./monte_carlo_files/Jpm_0.3/', -0.6, 1, -0.6, 0, 1, 20, n, 0, 0, 1, L, -9, 1, 250, 100000)
    scan_line('./monte_carlo_files/Jpm_-0.3/', 0.6, 1, 0.6, 0, 1, 20, n, 0, 0, 1, L, -9, 1, 250, 100000)
