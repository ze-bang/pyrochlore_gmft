...
SSSF_HHL_KK_integrated(100, 0.062, 0.063, 0.011, 0.35, h110, np.ones(4)*np.pi, -0.3, 0.3, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.11_Jyy=0.062_Jzz=0.063_B110=0.35_HHL_KnK_integrated")
SSSF_HHL_KK_integrated(100, 0.062, 0.063, 0.011, 1.5, h110, np.ones(4)*np.pi, -0.3, 0.3, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.11_Jyy=0.062_Jzz=0.063_B110=1.5_HHL_KnK_integrated")
