...
#
# DSSF(250, -2*Jpm, -2*Jpm, 1, 0, h111, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h111=0")
DSSF(250, -2*Jpm, -2*Jpm, 1, 0.2, h111, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h111=0.2")
DSSF(250, -2*Jpm, -2*Jpm, 1, 0.4, h111, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h111=0.4")
