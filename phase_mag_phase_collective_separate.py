...
hmin, hmax, field_dir, flux_String, Jpmpm, SLURM_ID, SLURM_SIZE, mpi_size = sys.argv[1:]
...
findPhaseMag_separate(Jpm_length_start, Jpm_length_end, nK, h_length_start, h_length_end, nK, flux, 30, 2, filename, Jpmpm=Jpmpm)
