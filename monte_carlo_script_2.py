...
SSSF_HHKnK_L_integrated(80, 0.062, 0.063, 0.011, 0, h110, np.ones(4)*np.pi, 1.25, 1.75, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.11_Jyy=0.062_Jzz=0.063_B110=0_HHKnK_L_integrated", 1.5, 0.3)
SSSF_HHKnK_L_integrated(80, 0.062, 0.063, 0.011, 0.35, h110, np.ones(4)*np.pi, 1.25, 1.75, 51, 30, "Files/SSSF/CZO_gaulin/Jxx=0.11_Jyy=0.062_Jzz=0.063_B110=0.35_HHKnK_L_integrated", 1.5, 0.3)
