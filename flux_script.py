...
DSSF(300, -2*Jpm, -2*Jpm, 1, 0, h001, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h001=0")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.05, h001, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h001=0.05")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.1, h001, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.289/h001=0.1")
