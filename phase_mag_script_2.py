...
SSSF(100, 0.062, 0.063, 0.011, 1.5, h110, np.ones(4)*np.pi, 30, 'Files/SSSF/Jxx_0.011_Jyy_0.062_Jzz_0.063_B110=1.5_hhk_1.5_zoomed_in', "hkk", 1.5, 1.5, 0.3)
SSSF(100, 0.062, 0.063, 0.011, 4, h110, np.ones(4)*np.pi, 30, 'Files/SSSF/Jxx_0.011_Jyy_0.062_Jzz_0.063_B110=4_hhk_1.5_zoomed_in', "hkk", 1.5, 1.5, 0.3)
