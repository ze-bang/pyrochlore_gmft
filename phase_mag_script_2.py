...
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.02, h110, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03/h110=0.02")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.04, h110, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03/h110=0.04")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.06, h110, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03/h110=0.06")
DSSF(300, -2*Jpm, -2*Jpm, 1, 0.08, h110, np.array([0,0,np.pi,np.pi]), 30, "Files/DSSF/Jpm=-0.03/h110=0.08")
