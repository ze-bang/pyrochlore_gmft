...
SSSF_line_pedantic(100, -2*Jpm, -2*Jpm, 1, 0, 0.6, 11, h110, zppz, 30, "Files/SSSF/Jpm=0.02_00pp", "hnhl")
...
# findPhaseMag111(-0.3125, 0.1, 40, 0, 0.4, 20, h111, 30, 2, "phase_111_kappa=2_Jpmpm=0.2", Jpmpm=0.1875)
