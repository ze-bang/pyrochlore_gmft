...
# SSSF_line_pedantic(100, -2*Jpm, -2*Jpm, 1, 0, 0.3, 11, h110, zppz, 30, "Files/SSSF/Jpm=-0.289_00pp", "hnhl")
...
findXYZPhase_separate(-1, 0, -1, 0, 40, 30, 2, np.zeros(4), "phase_XYZ_0_field_0_flux_nS=1_-1_0_-1_0",1, symmetrized=False)
