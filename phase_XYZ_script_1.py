...
#
DSSF_line(0.02, -2*Jpm, -2*Jpm, 1, 0, 0.5, 20, h110, np.zeros(4),30, "Files/DSSF/Jpm=-0.03_0")
DSSF_line(0.02, -2*Jpm, -2*Jpm, 1, 0, 0.5, 20, h110, np.ones(4)*np.pi, 30, "Files/DSSF/Jpm=-0.03_pi")
DSSF_line(0.02, -2*Jpm, -2*Jpm, 1, 0, 0.5, 20, h110, np.array([0,0,np.pi,np.pi]), 30, "Files/DSSF/Jpm=-0.03_pi_00pp")
