...
SSSF_line(100, 1, -2*Jpm, -2*Jpm, 0, 0.2, 5, h001, np.zeros(4),30, "Files/SSSF/Jpm=0.02_0")
SSSF_line(100, 1, -2*Jpm, -2*Jpm, 0, 0.2, 5, h001, np.ones(4)*np.pi, 30, "Files/SSSF/Jpm=0.02_pi")
