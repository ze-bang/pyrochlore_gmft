...
completeSpan(-0.1,0.1,100,0,0.3,100,h100,30,2,np.zeros(4),'HanYan_100_Jpm_-0.1_0.1_h_0_0.3_0_flux')
completeSpan(-0.1,0.1,100,0,0.3,100,h100,30,2,np.ones(4)*np.pi,'HanYan_100_Jpm_-0.1_0.1_h_0_0.3_pi_flux')
completeSpan(-0.1,0.1,100,0,0.3,100,h100,30,2,np.array([np.pi, 0,0, np.pi]),'HanYan_100_Jpm_-0.1_0.1_h_0_0.3_0pipi0')
completeSpan(-0.1,0.1,100,0,0.3,100,h100,30,2,np.array([0,np.pi,np.pi,0]),'HanYan_100_Jpm_-0.1_0.1_h_0_0.3_0_pi00pi')
