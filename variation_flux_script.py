...
Jpm = 0.02
SSSF_line(100, -2*Jpm, -2*Jpm, 1, 0, 0.5, 10, h001, hb110, np.zeros(4),30, "Files/SSSF/Jpm=0.02_0")
SSSF_line(100, -2*Jpm, -2*Jpm, 1, 0, 0.5, 10, h001, hb110, np.ones(4)*np.pi, 30, "Files/SSSF/Jpm=0.02_pi")
